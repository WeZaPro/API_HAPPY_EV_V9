...
// router.put(
//   "/updateConfirmQue/:Happy_Booking_ID",
//   reportTaxiTransaction.updateConfirmQue
// );

// delete  Taxi report by User
router.delete(
  "/deleteTransaction/:Happy_Booking_ID",
  [authJwt.verifyToken, authJwt.isUser],
  reportTaxiTransaction.deleteTransaction
);
